...
3. If you do not yet have a strong identifier, call `bookings.search` with only `tenantId` first to load the recent operator inbox, then refine from there.
